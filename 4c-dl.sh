...
wget -w 5 --random-wait -r -np -nH -nd -nc -e robots=off -A "jpg,jpeg,png,webp,gif,webm,mp4,mp3,m4a" -R "*s.jpg,*s.jpeg,*s.png,*s.webp,4chan-icon-*.png,filedeleted-res.gif" --regex-type pcre --reject-regex="[A-Fa-f0-9]{40}\.(?:gif|png|jpg|jpeg|webp)$" -H -q --show-progress "$threadURL"
